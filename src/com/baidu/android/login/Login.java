...
//    private TextView mChangepwdText;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.setContentView(R.layout.land_main);
...
//        startActivity(intent);
        ...
        //通过id找到相应的控件
        mAccount = (EditText) findViewById(R.id.landUser);
        mPwd = (EditText) findViewById(R.id.landPassword);
        mRegisterButton = (Button) findViewById(R.id.land_regButton);
        mLoginButton = (Button) findViewById(R.id.landButton);
//        mCancleButton = (Button) findViewById(R.id.Guideloginout);
